...
export function RootLayoutShell({
  ...
  return (
    <div className="relative flex min-h-screen overflow-x-hidden bg-[#FDFDFF] antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <main
        className={cn(
          "relative z-10 mb-24 flex flex-1 flex-col transition-all duration-200 ease-out md:mb-0",
          isCollapsed ? "md:ml-20" : "md:ml-64",
        )}
      >
        <header className="sticky top-0 z-[100] border-b border-slate-200/40 bg-white/80 backdrop-blur-3xl">
          <div className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-4 py-4 sm:px-6 sm:py-5 lg:px-10 xl:px-12">
            ...
            <div className="flex items-center gap-3 md:gap-5 lg:gap-6">
              ...
              <div className="mx-1 hidden h-8 w-px bg-slate-200/50 sm:block" />
              ...
              <button
                type="button"
                className="group flex items-center gap-2 rounded-sm bg-[#0052FF] px-4 py-2.5 shadow-xl shadow-blue-500/10 transition-all hover:bg-slate-950 active:scale-95 sm:px-5"
              >
        ...
        <section className="flex-1">
          <div className="mx-auto w-full max-w-[1440px] px-4 pb-8 pt-6 sm:px-6 sm:pb-10 sm:pt-8 lg:px-10 lg:pt-10 xl:px-12">
            <div
              className={cn(
                "rounded-2xl border border-white/50 bg-white/70 p-4 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.35)] backdrop-blur-sm sm:p-6 lg:p-8",
                activeTab === "dashboard" && "p-0 sm:p-0 lg:p-0 border-transparent bg-transparent shadow-none backdrop-blur-0",
              )}
            >
              <div className={cn("animate-[fadeIn_180ms_ease-out]", activeTab === "dashboard" ? "" : "space-y-6")}>
                {children}
              </div>
            </div>
          </div>
